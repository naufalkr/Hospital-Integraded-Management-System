    ...
    <header class="bg-cyan-950">
      ...
      >
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <button
            class="flex bg-teal-500 text-white px-4 py-2 rounded-lg font-regular"
          >
            Log Out
          </button>
        </div>
      ...
      <div class="w-1/3 bg-white">
        <div class="flex items-center mb-4 p-10">
          <img
            src=""
            alt="Profile Picture"
            class="bg-teal-500 text-white h-52 w-40 flex items-center justify-center rounded-lg mr-4"
          />
          <div>
            <!-- Nama Umur -->
        ...
        <div class="px-10">
          ...
          <div class="grid grid-cols-1 gap-2">
            ...
            <div class="flex justify-between">
              <span class="font-semibold text-cyan-950 text-sm"
                >Last Check Up:</span
              >
              <span class="text-gray-500"></span>
            </div>
      ...
      <div class="w-2/3">
        <div class="bg-[#f4f5f8] px-6 py-4 h-screen">
          <div class="flex space-x-4 mb-4">
            ...
            <button
              id="schedule-tab"
              class="text-gray-600 px-4 py-2 rounded-lg"
            >
              SCHEDULE
            </button>
          </div>
