...
function create_user(object $pdo, string $username,string $password,string $email,string $nama_pasien,string $alamat,string $no_telepon_pasien,string $jenis_kelamin){
